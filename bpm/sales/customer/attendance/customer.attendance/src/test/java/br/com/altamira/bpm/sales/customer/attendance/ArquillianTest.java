package br.com.altamira.bpm.sales.customer.attendance;
...
public class ArquillianTest {
  ...
  private static final String PROCESS_DEFINITION_KEY = "customer.attendance";
  ...
  public static WebArchive createDeployment() {
    ...
    return ShrinkWrap
            .create(WebArchive.class, "customer.attendance.war")
            ...
            .addPackages(false, "br.com.altamira.bpm.sales.customer.attendance") // not recursive to skip package 'nonarquillian'
            // add process definition
            .addAsResource("attendance-request.bpmn")
            // add process image for visualizations
            .addAsResource("attendance-request.png")
